...
// Simple variant utility to avoid class-variance-authority dependency
...
function toastClasses(variant: ToastVariant = "default") {
  return cn(toastBase, toastVariantClasses[variant])
}
...
>(({ className, variant = "default", ...props }, ref) => {
  return (
    <ToastPrimitives.Root
      ref={ref}
      className={cn(toastClasses(variant), className)}
      {...props}
    />
  )
})
